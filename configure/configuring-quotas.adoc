...
As an administrator, you can use {product-title} to configure quotas and limit access to GPUs, in order to optimize resource allocation and system throughput for user workloads.

// TODO: add outline of process
