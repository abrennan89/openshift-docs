...
This section describes the steps used to delete the API server source, trigger, service account, cluster role, and cluster binding using `kn` and `oc` commands.
