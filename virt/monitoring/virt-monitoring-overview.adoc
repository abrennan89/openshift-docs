...
* link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.21/html/monitoring_key_concepts/key-concepts#about-managing-alerts_key-concepts[alerts]
